  ...
  return (
    ...
    >
      ...
      >
        ...
        <button 
          onClick={handleClose}
          className="absolute top-4 right-4 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors bg-gray-100 dark:bg-[#1a1a1f] p-2 rounded-full border border-gray-200 dark:border-white/5 z-20 group"
        >
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-4 mb-10 relative">
          ...
          <div>
            <h2 className="text-4xl font-extrabold bg-gradient-to-r from-gray-900 via-violet-700 to-violet-500 dark:from-white dark:via-violet-200 dark:to-violet-400 bg-clip-text text-transparent tracking-tight">
              Tristan Barry
            </h2>
        ...
        {/* BLOC 1 : MOULINVEST */}
        <div className="group relative bg-gradient-to-br from-gray-50 to-white dark:from-[#1a1a20] dark:to-[#0f0f13] border border-gray-200 dark:border-violet-500/30 rounded-2xl p-8 mb-10 overflow-hidden transition-all duration-300 hover:border-violet-500/60 shadow-sm dark:shadow-[0_0_20px_rgba(139,92,246,0.15)]">
          ...
          <div className="relative z-10">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
              <div className="flex items-center gap-5">
                <div className="w-20 h-20 bg-white rounded-2xl p-2 flex items-center justify-center shadow-lg border-2 border-violet-100 dark:border-violet-500/20">
                  <img 
              ...
              <div className="bg-emerald-500/10 text-emerald-700 dark:text-emerald-300 px-4 py-2 rounded-xl text-sm font-bold border border-emerald-500/20 flex items-center gap-3 shadow-sm self-start md:self-center">
                 ...
                 <div className="flex flex-wrap gap-2 relative z-10">
                    {[
                      ...
                      'VLAN / DHCP', 'GLPI', 'PowerShell'
                        ...
                        <span key={tech} className="px-3 py-1.5 bg-gray-100 dark:bg-[#1f1f27] hover:bg-violet-500/10 text-gray-600 dark:text-gray-300 hover:text-violet-700 dark:hover:text-violet-100 text-xs font-medium rounded-lg border border-gray-200 dark:border-white/10 hover:border-violet-500/30 transition-all duration-200 cursor-default">
                            {tech}
                        </span>
                    ))}
                 </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
            <div className="lg:col-span-2 bg-gray-50 dark:bg-[#1a1a20] p-8 rounded-2xl border border-gray-200 dark:border-violet-500/10 hover:border-violet-500/30 transition-all duration-300 group">
            ...
            <div className="bg-gray-50 dark:bg-[#1a1a20] p-8 rounded-2xl border border-gray-200 dark:border-violet-500/10 hover:border-violet-500/30 transition-all duration-300 flex flex-col justify-center">
                ...
                <ul className="space-y-4">
                    ...
                    <li className="flex items-center justify-between p-3 bg-white dark:bg-[#13131a] rounded-xl border border-gray-200 dark:border-white/5 hover:border-green-500/30 transition-all">
                        <span className="text-gray-700 dark:text-gray-100 font-medium">Microsoft AZ-900</span>
                        <CheckCircle2 className="w-5 h-5 text-green-500" />
                    </li>
                </ul>
            </div>
        ...
        <div className="border-t border-gray-200 dark:border-white/10 pt-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div className="space-y-6">
                     <div className="bg-gray-50 dark:bg-[#1a1a20] p-6 rounded-2xl border border-gray-200 dark:border-violet-500/10 hover:border-yellow-500/30 hover:bg-yellow-500/5 transition-all duration-300 group">
                     ...
                     <div className="bg-gray-50 dark:bg-[#1a1a20] p-6 rounded-2xl border border-gray-200 dark:border-violet-500/10 hover:border-red-500/30 hover:bg-red-500/5 transition-all duration-300 group">
                        <div className="flex items-start gap-4">
