...
<section className="mb-16">
  ...
  I'm currently transitioning into cybersecurity through a <strong>professional retraining path</strong>. In September, I’ll begin a <strong>formal work-study program</strong> focused on IT and networking, but my journey started long before that. I used to work as a <strong>field technician in fiber optics</strong> — pulling cables, climbing ladders, doing repetitive installations. Over time, I began to feel a <strong>deep disconnect</strong>: I wasn’t learning, I wasn’t evolving, and I didn’t see long-term meaning in what I was doing. That realization was the <strong>turning point</strong>.<br /><br />
  
  I made the choice to pivot into a field that truly resonates with me: <strong>cybersecurity</strong>. And from that moment on, I’ve been <strong>going all-in</strong>. For the past nine months, I’ve trained rigorously on my own — studying <strong>6 to 7 hours a day</strong>, nearly every day. I completed all the learning paths on <strong>TryHackMe</strong>, passed the <strong>eJPT certification</strong>, and most recently earned the <strong>CPTS</strong> from Hack The Box. This wasn’t just about collecting badges. It was about building <strong>real, practical skills</strong> and proving to myself that I could reach a <strong>professional standard</strong> through <strong>hard work and dedication</strong>.<br /><br />
  
  I consider myself a <strong>“tryharder”</strong> — when something ignites my passion, I give it <strong>300%</strong>. I’m obsessive about <strong>documenting everything I learn</strong>, not just to track progress, but because writing it down helps me understand it deeply. My workflow revolves around a <strong>custom Exegol offensive environment</strong>, with <strong>Obsidian</strong> for knowledge management and <strong>SysReptor</strong> for real-time reporting. I believe learning should be <strong>active, structured, and brutally honest</strong>. I don’t skip steps. I don’t cut corners.<br /><br />
  
  This article isn’t just about showcasing a personal success. I’m writing it to <strong>give back</strong> — plain and simple. When I was preparing for the CPTS, one of the most valuable resources I came across was the blog and methodology shared by <a href="https://www.brunorochamoura.com/posts/cpts-tips/" target="_blank" className="text-violet-400 hover:underline"><strong>Bruno Rocha Moura</strong></a>. His insights helped me structure my preparation, stay focused, and understand what truly mattered. In the same spirit, I hope this write-up can help someone else: whether you're hesitating to take the exam, wondering how to prepare, or simply looking for a roadmap from someone who's walked the path.<br /><br />
  
  <strong>Sharing knowledge is at the core of this field.</strong> We all stand on the shoulders of others — from write-ups, Discord chats, community forums, and blog posts — and I believe we have a <strong>duty to contribute in return</strong>. If this article helps even one person find clarity, confidence, or direction, then it has <strong>served its purpose</strong>.
</p>
