      ...
      <div className="sticky top-24 self-start max-h-[calc(100vh-8rem)] overflow-y-auto custom-scrollbar pr-4 pb-8">
        <div className="relative p-6 rounded-2xl bg-[#0a0a0f]/60 backdrop-blur-md border border-white/5 shadow-2xl overflow-hidden group">
          ...
          <div className="flex items-center gap-3 mb-6">
              ...
              <h4 className="text-[11px] font-black text-gray-400 uppercase tracking-[0.25em]">Sommaire</h4>
          </div>
          <TocLinks />
          ...
          <div className="absolute top-0 right-0 p-1 opacity-10"><div className="w-6 h-6 border-t border-r border-violet-500" /></div>
          <div className="absolute bottom-0 right-0 p-1 opacity-10"><div className="w-6 h-6 border-b border-r border-violet-500" /></div>
        </div>
      </div>
    </aside>
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-3 border-b border-white/5 shrink-0">
              <div className="flex items-center gap-2 text-violet-400">
                <div className="p-1.5 rounded-lg bg-violet-500/10 border border-violet-500/20"><List size={14} /></div>
                <span className="text-xs font-black uppercase tracking-[0.2em]">Sommaire</span>
              </div>
              <button onClick={() => setMobileOpen(false)} className="p-1.5 text-gray-500 hover:text-white transition-colors"><X size={18} /></button>
            </div>
